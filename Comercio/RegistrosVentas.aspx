...
<div class="login-container" style="display: flex; flex-direction: column; align-items: center; max-width: 600px; margin: 0 auto; margin-top: 10px;">
    ...
    <asp:Button runat="server" ID="btnBuscarVentas" Text="Buscar Venta" CssClass="btn btn-primary" OnClick="btnBuscarVentas_Click" />
</div>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <asp:GridView ID="dataGridViewVentas" runat="server" AutoGenerateColumns="False" CssClass="gridview-style" DataKeyNames="IdVenta"
            AllowPaging="true" PageSize="7" OnPageIndexChanging="dataGridViewVentas_PageIndexChanging" OnSelectedIndexChanged="dataGridViewVentas_SelectedIndexChanged"  OnRowCommand="dataGridViewVentas_RowCommand" OnRowDataBound="dataGridViewVentas_RowDataBound">
