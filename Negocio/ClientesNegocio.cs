...
namespace Negocio
{
    public class ClientesNegocio
    {
        ...
        public List<Clientes> ListarClientes(string id = "")
        {
            ...
            try
            {
                datos.SetearQuery("select ClienteID, Nombre, Apellido, Mail from Clientes");
        ...
        public long AgregarClientes(Clientes nuevo)
        {
            try
            {
                ...
                {
                    Datos.SetearQuery("INSERT INTO Clientes (Nombre, Apellido, Mail) VALUES (@Nombre, @Apellido, @Mail); SELECT SCOPE_IDENTITY();");
